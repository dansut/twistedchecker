...
class PyCodeStyleChecker(BaseChecker):
    ...
    mapPyCodeStyleMessages = {
        ...
        'W391': ('W9017', ''),
        'W292': ('W9018', ''),
        'E201': ('W9019', r"whitespace after '(.+)'"),
        'E202': ('W9020', r"whitespace before '(.+)'"),
        'E203': ('W9020', r"whitespace before '(.+)'"),
        'E211': ('W9020', r"whitespace before '(.+)'"),
        'E231': ('W9021', r"missing whitespace after '(.+)'"),
        'E222': ('W9022', ''),
        'E221': ('W9023', ''),
        'E225': ('W9024', ''),
        'E251': ('W9025', ''),
